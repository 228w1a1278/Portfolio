        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button 
              ...
              className="bg-gradient-hero text-background font-semibold hover:shadow-glow transition-all duration-300"
            >
              Get In Touch
            </Button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-border">
            <div className="flex flex-col space-y-4">
              ...
              <Button 
                onClick={() => scrollToSection('#contact')}
                className="bg-gradient-hero text-background font-semibold self-start"
              >
                Get In Touch
              </Button>
            </div>
